 ...
 void main()
 {
	...
	// void acknow()
	 ...
	 // cleardevice();
	  ...
	  outtextxy(40,90,"thanks to my mam :Mrs. SHWETA  whose");
	  ...
	  outtextxy(40,330,"SIMRAN                ");
	  outtextxy(40,360,"XII A , 2018 - 19       ");
	  outtextxy(40,390,"M C L Sraswati Bal Mandir  ");
	  getch();
	  cleardevice();
	 ...
	 // FOR VERIFICATION
	  ...
	  settextstyle(1,0,3);
	   setcolor(BLACK);
	  outtextxy(40,60,"I simran submitting this project");
	    outtextxy(40,90,"as an evidence of my work in computer");
	    outtextxy(40,120,"lab. ");
	    outtextxy(40,190,"SUBMITTED BY:-              SUBMITTED TO:-");
	    outtextxy(40,220,"SIMRAN                     Mrs.SHWETA ");
	     outtextxy(40,250,"XII A,2018 -19              lecturer in computer");
	  getch();
	  cleardevice();
